...
public class Point implements Comparable<Point> {
    ...
    private static class CompareBySlope implements Comparator<Point> {

        private final Point thisPoint;

        public CompareBySlope(Point thisPoint) {
            this.thisPoint = thisPoint;
        }

        public int compare(Point point1, Point point2) {
            double slope1 = thisPoint.slopeTo(point1);
            double slope2 = thisPoint.slopeTo(point2);
